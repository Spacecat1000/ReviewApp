...
function populate() {
	fetch("https://api.myjson.com/bins/9ap1b")
	.then(x=>x.json())
	.then(x=>data = x)
	.then(()=> {
		list.innerHTML += Array(parseInt(data.length)).join("<li><img><div><h2></h2><h3></h3><p></p><br>Love <span></span>?<span><img>Yes!</span><br><span>15</span> people said yes!</div></li>");
